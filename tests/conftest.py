...
from gmail_fisher.models import GmailMessage, FoodExpense, FoodServiceType


@pytest.fixture
def food_expenses_5() -> Iterable[FoodExpense]:
    return [
        FoodExpense(
            id="79aa8544-aa05-4a0c-8120-a83b665dbed2",
            service=FoodServiceType.BOLT_FOOD,
        ...
        FoodExpense(
            ...
            service=FoodServiceType.UBER_EATS,
